...
#   - Saved as a Portkey Config (id: settings.PORTKEY_CONFIG) since this org has
#     block_inline_config enabled — inline strategy/cache/retry/targets dicts are rejected.
#   - Fallback: primary @rv66-groq-healthcare-agent/openai/gpt-oss-20b → @rv-dau-new-groq-healthcare-agent/openai/gpt-oss-20b on failure
#   - Cache: simple mode
